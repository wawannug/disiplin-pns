export const pejabat = [
    ...
    {
        indeks: 3,
        jabatan: "Pejabat Pimpinan Tinggi Madya atau pejabat lain yang setara",
        info: [
            {
    ...
    {
        indeks: 4,
        jabatan: "Pejabat Pimpinan Tinggi Pratama atau pejabat lain yang setara",
        info: [
            {
    ...
    {
        indeks: 6,
        jabatan: "Pejabat Pengawas atau pejabat lain yang setara",
        info: [
            {
...
export const informasi = [
    ...
    {
        indeks: 1,
        info: ["Dalam hal tidak terdapat Pejabat yang Berwenang Menghukurn, maka kewenangan menjatuhkan Hukuman Disiplin menjadi kewenangan pejabat yang lebih tinggi"]
    }
]