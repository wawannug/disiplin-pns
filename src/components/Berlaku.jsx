...
const Berlaku = () => {
    ...
    return (
        <div className="mt-20 mb-10 min-h-screen md:5/6 lg:w-2/3 mx-auto font-Montserrat-Regular md:h-screen dark:text-white dark:bg-[#0f172a]">
            ...
            <div className="mt-5">
                {berlaku[indeks].konten.map((item) => (
                    <div className='p-2 m-2  bg-[#e4fab8] dark:bg-[#0f172a] dark:outline-white dark:outline dark:outline-1 rounded-xl'>{item.uraian}</div>
                ))
                }
            </div>
